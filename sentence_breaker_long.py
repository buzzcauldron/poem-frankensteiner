...
# Multiplier range for 3-5x increase
MULTIPLIER_MIN = 3.0
MULTIPLIER_MAX = 5.0
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Create highly reduced broken-line texts grouped into lines with 3-5x longer syllables (18-60 syllables) with random fluctuation."
    )
    parser.add_argument(
        "input",
        nargs="?",
